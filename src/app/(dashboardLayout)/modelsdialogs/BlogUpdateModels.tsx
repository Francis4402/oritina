...
const UpdateBlogsModel = ({ blog }: {blog: blog}) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger asChild>
            <Button variant={"default"} size={"sm"}><Plus />Update Blogs</Button>
        </DialogTrigger>
        <DialogContent>
            <DialogHeader className='flex items-center'>
                <DialogTitle>Update Blogs</DialogTitle>
            </DialogHeader>
...
export default UpdateBlogsModel